...
function apertarBotao() {
    ...
    if (altura <= 0 || peso <= 0 || idade <= 0) {
        alert("Por favor, insira valores positivos e maiores que 1 para altura, peso e idade.");
        return;
    }
    ...
    // Exibe o resultado
    document.getElementById("resultado").innerText = `Sua Taxa Metabólica Basal (TMB) é: ${tmbTotal.toFixed(2)} calorias por dia.`;
}
